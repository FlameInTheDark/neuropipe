...
export const icons = {
  ...
  Cable, CalendarDays, Camera, Check, ChevronDown, ChevronLeft, ChevronRight, ChevronsDownUp, ChevronsUpDown, CircleDot, CircleHelp, Clock, Code, Columns3, Command, Copy, CornerDownLeft, Crosshair,
  Database, Download,
  ...
  Table2, TableProperties, Tags, Text, TextCursorInput, Trash2, TrendingUp,
  UploadCloud,
  X,
  Zap, ZoomIn, ZoomOut,
