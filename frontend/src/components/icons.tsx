...
export const icons = {
  ...
  Cable, CalendarDays, Camera, Check, ChevronDown, ChevronLeft, ChevronRight, CircleDot, CircleHelp, Clock, Code, Columns3, Command, Copy, CornerDownLeft, Crosshair,
  Database, Download,
  ...
  Package, PackageOpen, PanelLeft, PanelRight, Pencil, PencilLine, Pin, Play, Plus,
  Radio, RefreshCw, Route,
  Save, Search, Send, Settings2, ShieldCheck, Smile, Sparkles,   Split, Square, SquareFunction, StickyNote,
