...
const catalogs: Record<CatalogLanguage, CatalogTranslations> = {
  de: {
    categories: { Triggers: 'Auslöser', Actions: 'Aktionen', Local: 'Lokal', AI: 'KI', Canvas: 'Canvas', Data: 'Daten', Math: 'Mathematik', Flow: 'Ablauf', Chat: 'Chat', Functions: 'Funktionen' },
    titles: {
    ...
    terms: { Exec: 'Ausführen', Then: 'Dann', Start: 'Start', Input: 'Eingabe', Output: 'Ausgabe', Payload: 'Nutzdaten', Result: 'Ergebnis', Value: 'Wert', Text: 'Text', Source: 'Quelle', Key: 'Schlüssel', Object: 'Objekt', Equal: 'Gleich', True: 'Wahr', False: 'Falsch', Error: 'Fehler', Condition: 'Bedingung', Selection: 'Auswahl', Default: 'Standard', Array: 'Array', 'Loop Body': 'Schleifenkörper', Completed: 'Abgeschlossen', 'Array Element': 'Array-Element', 'Array Index': 'Array-Index', Index: 'Index', 'First Index': 'Erster Index', 'Last Index': 'Letzter Index', Reset: 'Zurücksetzen', Enter: 'Eingang', Open: 'Öffnen', Close: 'Schließen', Toggle: 'Umschalten', 'Chat ID': 'Chat-ID', 'Chat Run ID': 'Chat-Run-ID', Messages: 'Nachrichten', Status: 'Status', Tools: 'Werkzeuge', 'Button label': 'Schaltflächenname', 'Global hotkey': 'Globaler Hotkey', 'Cron expression': 'Cron-Ausdruck', Timezone: 'Zeitzone', Path: 'Pfad', 'Signing secret': 'Signaturgeheimnis', 'Chat label': 'Chat-Name', URL: 'URL', Method: 'Methode', Body: 'Inhalt', Content: 'Inhalt', Shell: 'Shell', Command: 'Befehl', 'Working directory': 'Arbeitsverzeichnis', Title: 'Titel', Message: 'Nachricht', 'Report title': 'Berichtstitel', Tags: 'Tags', Markdown: 'Markdown', Operation: 'Vorgang', Repository: 'Repository', Pipeline: 'Pipeline', Prompt: 'Prompt', 'Model override': 'Modellüberschreibung', Instructions: 'Anweisungen', 'Fields to extract': 'Zu extrahierende Felder', Question: 'Frage', Options: 'Optionen', 'Maximum turns': 'Maximale Schritte', Task: 'Aufgabe', Workspace: 'Arbeitsbereich', Format: 'Format', Outputs: 'Ausgaben', 'Target type': 'Zieltyp', 'JSON path': 'JSON-Pfad', 'Variable name': 'Variablenname', Limit: 'Limit', 'Start open': 'Offen starten', Loop: 'Schleife', 'Response body': 'Antwortinhalt', Headers: 'Header', JSON: 'JSON', 'Report ID': 'Bericht-ID', 'Created at': 'Erstellt am', Decision: 'Entscheidung', Choice: 'Auswahl', 'Request headers': 'Anfrage-Header', 'Use custom User-Agent': 'Eigenen User-Agent verwenden', 'User-Agent': 'User-Agent' },
  ...
  fr: {
    categories: { Triggers: 'Déclencheurs', Actions: 'Actions', Local: 'Local', AI: 'IA', Canvas: 'Canvas', Data: 'Données', Math: 'Mathématiques', Flow: 'Flux', Chat: 'Discussion', Functions: 'Fonctions' },
    titles: {
      ...
      'action:http': 'Requête HTTP', 'action:file_read': 'Lire un fichier', 'action:file_write': 'Écrire un fichier', 'action:terminal': 'Exécuter une commande terminal', 'action:notification': 'Notification de bureau', 'action:report': 'Créer un rapport', 'action:git': 'Git', 'action:subpipeline': 'Exécuter un pipeline', 'action:chat_reply': 'Répondre à la discussion', 'action:chat_status': 'Mettre à jour le statut de discussion',
  ...
  ru: {
    categories: { Triggers: 'Триггеры', Actions: 'Действия', Local: 'Локальные', AI: 'ИИ', Canvas: 'Холст', Data: 'Данные', Math: 'Математика', Flow: 'Поток', Chat: 'Чат', Functions: 'Функции' },
    titles: {
      ...
      'action:http': 'HTTP-запрос', 'action:file_read': 'Чтение файла', 'action:file_write': 'Запись файла', 'action:terminal': 'Запуск команды терминала', 'action:notification': 'Уведомление рабочего стола', 'action:report': 'Создать отчёт', 'action:git': 'Git', 'action:subpipeline': 'Запустить пайплайн', 'action:chat_reply': 'Ответить в чат', 'action:chat_status': 'Обновить статус чата',
      ...
      'visual:comment': 'Комментарий', 'data:constant': 'Константа', 'data:format_text': 'Форматировать текст', 'data:get_field': 'Получить поле', 'data:build_object': 'Собрать объект', 'data:break_object': 'Разобрать объект', 'data:cast': 'Преобразовать тип', 'data:json_query': 'Запрос JSON', 'data:equals': 'Равно', 'data:greater_than': 'Больше чем', 'data:json_parse': 'Разобрать JSON', 'data:get_variable': 'Получить переменную', 'data:chat_history': 'Прочитать историю чата', 'data:reroute': 'Перенаправление',
    ...
    terms: { Exec: 'Выполнение', Then: 'Затем', Start: 'Старт', Input: 'Вход', Output: 'Выход', Payload: 'Данные', Result: 'Результат', Value: 'Значение', Text: 'Текст', Source: 'Источник', Key: 'Ключ', Object: 'Объект', Equal: 'Равно', True: 'Да', False: 'Нет', Error: 'Ошибка', Condition: 'Условие', Selection: 'Выбор', Default: 'По умолчанию', Array: 'Массив', 'Loop Body': 'Тело цикла', Completed: 'Завершено', 'Array Element': 'Элемент массива', 'Array Index': 'Индекс массива', Index: 'Индекс', 'First Index': 'Первый индекс', 'Last Index': 'Последний индекс', Reset: 'Сброс', Enter: 'Вход', Open: 'Открыть', Close: 'Закрыть', Toggle: 'Переключить', 'Chat ID': 'ID чата', 'Chat Run ID': 'ID запуска чата', Messages: 'Сообщения', Status: 'Статус', Tools: 'Инструменты', 'Button label': 'Название кнопки', 'Global hotkey': 'Глобальная горячая клавиша', 'Cron expression': 'Cron-выражение', Timezone: 'Часовой пояс', Path: 'Путь', 'Signing secret': 'Секрет подписи', 'Chat label': 'Название чата', URL: 'URL', Method: 'Метод', Body: 'Тело', Content: 'Содержимое', Shell: 'Оболочка', Command: 'Команда', 'Working directory': 'Рабочая папка', Title: 'Заголовок', Message: 'Сообщение', 'Report title': 'Название отчёта', Tags: 'Теги', Markdown: 'Markdown', Operation: 'Операция', Repository: 'Репозиторий', Pipeline: 'Пайплайн', Prompt: 'Промпт', 'Model override': 'Переопределение модели', Instructions: 'Инструкции', 'Fields to extract': 'Поля для извлечения', Question: 'Вопрос', Options: 'Варианты', 'Maximum turns': 'Максимум шагов', Task: 'Задача', Workspace: 'Рабочая папка', Format: 'Формат', Outputs: 'Выходы', 'Target type': 'Целевой тип', 'JSON path': 'Путь JSON', 'Variable name': 'Имя переменной', Limit: 'Лимит', 'Start open': 'Открыт при запуске', Loop: 'Цикл', 'Response body': 'Тело ответа', Headers: 'Заголовки', JSON: 'JSON', 'Report ID': 'ID отчёта', 'Created at': 'Создано', Decision: 'Решение', Choice: 'Выбор', 'Request headers': 'Заголовки запроса', 'Use custom User-Agent': 'Использовать свой User-Agent', 'User-Agent': 'User-Agent' },
