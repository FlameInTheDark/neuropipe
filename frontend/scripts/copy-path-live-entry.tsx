/* Browser entry for the copy-path live test: mounts the REAL JsonViewerModal
   ...
   window.__clipboardWrites. Bundled to IIFE by render-copypath-live.mts and
   inlined into a standalone page next to the app's compiled CSS. */
...
createRoot(el).render(<JsonViewerModal entry={entry} onClose={() => {}} />);
