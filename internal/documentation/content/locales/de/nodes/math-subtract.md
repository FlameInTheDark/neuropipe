...
Subtrahiert die Zahl **B** von der Zahl **A**. Der reine Knoten hat keine Ausführungspins und keine Nebenwirkungen.
...
Beide Eingaben müssen endliche Zahlen sein. `Aktueller Wert` → **A** und `Basiswert` → **B** ergeben die Differenz.
