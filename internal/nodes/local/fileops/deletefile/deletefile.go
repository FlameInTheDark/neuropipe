// Package deletefile registers the Delete File Blueprint node.
package deletefile
...
func definition() domain.NodeDefinition {
	...
	return domain.NodeDefinition{
		Type:        "action:delete_file",
		Category:    "Files",
		Label:       "Delete File",
		Description: "Delete a regular file. Optionally succeed when the file is already missing.",
		Icon:        "file-x",
		Color:       "#c4b5fd",
		...
		Fields: []domain.ConfigField{
			{Name: "path", Label: "Path", Kind: "string", Placeholder: "C:\\Work\\stale.txt", Required: true},
...
func execute(_ context.Context, invocation nodes.Invocation, _ nodes.Runtime) (nodes.ExecutionResult, error) {
	...
	if err != nil {
		return nodes.ExecutionResult{}, fmt.Errorf("delete file: %w", err)
	}
